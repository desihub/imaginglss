...
DECAM_FLUX_INVVAR = C('DECAM_FLUX_INVVAR').T
DECAM_MW_TRANSMISSION = C('DECAM_MW_TRANSMISSION').T

# 1-sigma limits
G_LIMIT = DECAM_FLUX_INVVAR[1] ** -0.5 / DECAM_MW_TRANSMISSION[1]
Z_LIMIT = DECAM_FLUX_INVVAR[4] ** -0.5 / DECAM_MW_TRANSMISSION[4]
R_LIMIT = DECAM_FLUX_INVVAR[2] ** -0.5 / DECAM_MW_TRANSMISSION[2]
